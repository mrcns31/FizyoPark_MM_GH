...
function makeStyles(colors: AppColors, theme: ResolvedTheme) {
  return StyleSheet.create({
    ...
    staffSummary: {
      ...
      borderTopColor: surfaceTint(theme, 0.08),
    ...
    monthSummaryCard: {
      ...
      borderColor: surfaceTint(theme, 0.1),
      backgroundColor: surfaceTint(theme, 0.04),
      gap: 10,
    },
    ...
    monthSummaryDivider: { height: StyleSheet.hairlineWidth, backgroundColor: surfaceTint(theme, 0.12) },
