...
/** Web remainingSessionsColor — ratio'ya göre yeşil/turuncu/kırmızı */
...
export function AdminMembersScreen() {
  ...
  // Herhangi bir paketi (aktif/bitmiş) olan üye ID'leri
  ...
  // Ana liste: sadece aktif paketi olanlar + filtre + sıralama
  // Paketsiz uyarı: hiç paketi olmayanlar (filtreden bağımsız)
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.sortRow}>
          {([
            ...
            return (
              <Pressable
                key={col}
                style={[styles.sortChip, isActive && styles.sortChipOn]}
                onPress={() => onSort(col)}
              >
